...
The Django application was developed with substantial help from an AI assistant (Claude); I do not claim to have hand-written it. The modernisation (container, AWS architecture, Terraform, pipeline, security work) was also implemented with an AI assistant as a pair programmer. I defined the goals and constraints, owned the architecture and technology decisions, provided and operated the AWS environment, ran and verified the deployment, and can explain every part of the system. See [Who built what](docs/ARCHITECTURE.md#who-built-what).
